...
# Update model configuration with a supported model
CONFIG_MODELOS = {
    'Groq': {
        'modelos': ['llama-3.3-70b-versatile','gemma2-9b-it','llama3-8b-8192'],  # Update this with the new model name
        'chat': ChatGroq
    },
    'OpenAI': {
...
def carrega_modelo(provedor, modelo, api_key, tipo_arquivo, arquivo):
    ...
    api_key= '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'
